...
export default function AdminTeamPage() {
  ...
  const [group, setGroup] =
    useState<TeamMember["group"]>("board");
    ...
    fetch(API_URL, { cache: "no-store", signal: controller.signal })
      ...
      .catch((error: unknown) => {
        if (!controller.signal.aborted) {
          setError(error instanceof Error ? error.message : "Could not load team.");
        }
      })
    ...
    <main className="min-h-screen bg-gray-100 py-8 sm:py-10">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <p className="mt-2 text-sm text-gray-500 sm:text-base">
          Manage Board, Audit Committee and
          Management Team from one place.
        </p>
        ...
        >
          ...
          <p className="mt-1 text-sm text-gray-500">
            Name and position can be entered
