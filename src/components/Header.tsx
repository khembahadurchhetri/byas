...
"
        ...
        <div className="w-full border border-red-500 bg-[#162E6A] px-4 py-3 text-center text-white md:w-auto md:min-w-[300px]">
          <p className="text-xs font-semibold tracking-wide">
            Transaction Hour
          </p>

          <p className="mt-1 text-xs">9:00 AM to 4:00 PM (Mon to Fri)</p>

          <p className="mt-1 text-[11px]">कार्यालय समय: १०:०० देखि ५:०० सम्म</p>
        </div>
      </div>
    </header>
  );
