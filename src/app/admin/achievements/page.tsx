...
export default function AdminAchievementsPage() {
  ...
  useEffect(() => {
    ...
    fetch(API_URL, { cache: "no-store", signal: controller.signal })
      ...
      .then((data) => { if (!controller.signal.aborted) setAchievements(data); })
      .catch((error: unknown) => {
        if (!controller.signal.aborted) {
          setError(error instanceof Error ? error.message : "Could not load achievements.");
        }
      })
        ...
        >
          ...
          <div className="mt-5 grid gap-4 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                className="w-full resize-y rounded-lg border border-gray-300 px-4 py-3 outline-none focus:border-green-600"
              />
            </div>
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <button
              type="submit"
              disabled={loading}
              className="rounded-lg bg-green-700 px-6 py-3 font-medium text-white disabled:opacity-50"
            >
              {loading
                ? "Saving..."
                : editingId
